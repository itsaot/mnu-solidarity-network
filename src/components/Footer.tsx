      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="animate-fade-in">
            <h3 className="text-xl font-bold text-mnu-gold mb-4">Mkhonto National Union</h3>
            <p className="mb-4">Empowering workers across South Africa</p>
          </div>
          
          <div className="animate-fade-in" style={{animationDelay: "0.2s"}}>
            <h3 className="text-xl font-bold text-mnu-gold mb-4">Quick Links</h3>
          ...
          <div className="animate-fade-in" style={{animationDelay: "0.4s"}}>
            <h3 className="text-xl font-bold text-mnu-gold mb-4">Contact Information</h3>
            <div className="space-y-3">
              <div className="flex items-center">
                <MapPin className="mr-2 text-mnu-gold" size={18} />
                <a 
              ...
              <div className="flex items-center">
                <Mail className="mr-2 text-mnu-gold" size={18} />
              ...
              <div className="flex items-center">
                <Phone className="mr-2 text-mnu-gold" size={18} />
