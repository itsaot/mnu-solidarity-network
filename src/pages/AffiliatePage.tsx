      ...
      <div className="flex-grow py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center max-w-2xl mx-auto mb-8 text-gray-600 animate-fade-in" style={{animationDelay: "0.2s"}}>
            The Mkhonto National Union welcomes all Africans who believe in economic freedom, 
          ...
          <Alert className="max-w-2xl mx-auto mb-6 animate-fade-in border-green-200" style={{animationDelay: "0.25s"}}>
            ...
            <AlertTitle className="text-green-700 font-semibold">Payment Required - R50 Joining Fee (once off)</AlertTitle>
            <AlertDescription className="text-green-700">
              ...
              <ul className="list-disc pl-5 mt-1 space-y-1">
                <li>Account Holder: <span className="font-medium">Mkhonto National Union</span></li>
          ...
          <div className="text-center max-w-2xl mx-auto mb-6 text-black text-sm font-medium animate-fade-in bg-gray-100 p-3 rounded-md border border-gray-200" style={{animationDelay: "0.3s"}}>
          ...
          <div className="text-center max-w-2xl mx-auto mb-6 text-black text-sm font-medium animate-fade-in bg-white p-3 rounded-md border border-green-200" style={{animationDelay: "0.3s"}}>
